...
public class IconActivity extends AppCompatActivity {
    ...
    private void createLayout(int width) {
        ...
        for (int i = 0; i < images.length; i++) {
            ...
            PaperImageUtils.bitmapLoadAsync(imageList.get(i), getApplicationContext(), getApplicationContext().getResources(), "nodpi_" + images[i], (windowWidth / width) - (margin * width + margin) / width, (windowWidth / width) - (margin * width + margin) / width);
